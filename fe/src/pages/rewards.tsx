import { Button, Flex, Spinner, Text, useBoolean, useToast } from "@chakra-ui/react";
...
import { generateContract, setActiveMenu } from "../reduxs/accounts/account.actions";
    ...
    <>
      ...
      <Flex flex={1} direction="column" alignItems="center">
        ...
        <Button
          variant="primary"
          w={{ base: "100%", lg: "30%" }}
          isDisabled={!walletInfo.address || !web3Provider || isProcess || info?.balance === 0}
          disabled={!walletInfo.address || !web3Provider || isProcess || info?.balance === 0}
          onClick={handleClaim}
        >
          {isProcess ? <Spinner /> : `CLAIM ${numberFormat(info?.balance || 0)} REWARDS`}
        </Button>
      </Flex>
    </>
  );
