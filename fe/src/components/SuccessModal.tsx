...
export default function SuccessModal({ hash, isSuccess = true, ...props }: IProps) {
  const onNavigation = () => {
    if (window) {
  ...
  const description = isSuccess ? 'you have been doubled' : 'maybe your luck next time';
      ...
      <ModalContent py="30px" bg={bgColor}>
        ...
        <ModalBody>
          ...
          >
            ...
            <Text variant="notoSan" fontFamily={fonts.STATE_WIDE} fontSize="20px" textTransform="uppercase">
             {sTitle}
            </Text>  

            <Text variant="notoSan" fontFamily={fonts.STATE_WIDE} fontSize="12px" mt="10px" textTransform="uppercase">
              {description}
            </Text>           
